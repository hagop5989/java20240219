...
public class C04Quantifier {
    public static void main(String[] args) {
        ...
        System.out.println("8".matches(p1)); // false
        ...
        System.out.println("손".matches(p5));// true
        System.out.println("손흥민손".matches(p5));// true
        System.out.println("손son".matches(p5));// true


        // ? : {0,1} //적용하려는 문자 뒤에 적음
        String p6 = "010-{0,1}\\d{4}-{0,1}\\d{4}";
//        String p7 = "010-?\\d{4}-?\\d{4}"; // 동일
